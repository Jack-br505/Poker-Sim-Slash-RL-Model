...
#Get a proability of winning for every hand combination in a 4 plyaer game with first 3 community cards specified.
four_player_results = []
...
for card1 in default_deck_cards:
    for card2 in default_deck_cards:
        for card3 in default_deck_cards:
            for card4 in default_deck_cards:
                for card5 in default_deck_cards:
                    if card1 != card2 and card1 != card3 and card1 != card4 and card1 != card5 and card2 != card3 and card2 != card4 and card2 != card5 and card3 != card4 and card3 != card5 and card4 != card5:
                        ...
                        flop_tuple = (card3, card4, card5)
                        results['flop'] = flop_tuple

                        community = {0: flop_tuple[0], 1 : flop_tuple[1], 2 : flop_tuple[2], 3 : None, 4 : None}
                        
                        sim_results = many_games(n, card1=card1, card2=card2, community=community, print_output=False)
...
try:    
    with open("4_player_results_w_flop.csv", "r", newline="", encoding="utf-8") as file:
